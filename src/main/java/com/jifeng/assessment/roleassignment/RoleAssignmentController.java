// 模块用途：项目角色分配REST接口——提供分配人员、标记PD负责人、移除分配API
// 依赖文件：RoleAssignmentService.java, ProjectRoleAssignmentDTO.java, BaseController.java
// 修改注意：接口路径统一以 /api/v1/projects/{projectCode}/assignments 开头
